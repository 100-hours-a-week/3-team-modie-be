...
public class UserService {
    ...
    public void saveOrUpdateFcmToken(User user, String deviceId) {
        Optional<FcmToken> existing = fcmTokenRepository.findByDeviceId(deviceId);
        ...
        if (existing.isPresent()) {
            ...
            FcmToken newToken = FcmToken.builder()
                .user(user)
                .deviceId(deviceId)
                .token("") // 추후 클라이언트에서 FCM 토큰 등록할 수도 있음
                .deviceType("web")
                .build();
