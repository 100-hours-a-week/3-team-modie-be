...
public enum CustomErrorCode implements ErrorCode {
    ...
    MEMBER_LIMIT_TOO_LOW(400, "M023", CustomErrorMessage.MEMBER_LIMIT_TOO_LOW),
    MEMBER_LIMIT_LESS_THAN_CURRENT(400, "M024", CustomErrorMessage.MEMBER_LIMIT_LESS_THAN_CURRENT),
